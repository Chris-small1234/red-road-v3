...
class Spiritual_Results extends StatefulWidget {
  const Spiritual_Results({Key? key}) : super(key: key);

  @override
  _Spiritual_ResultsState createState() => _Spiritual_ResultsState();
}

class _Spiritual_ResultsState extends State<Spiritual_Results> {
  String score = "0";
  Api api = new Api();
  ...
  List<BarChartGroupData> get barGroups => [
        BarChartGroupData(
          ...
          barRods: [
            BarChartRodData(
                y: double.parse(thisScore), colors: [Colors.grey, Colors.grey])
          ],
        ...
        BarChartGroupData(
          ...
          barRods: [
            BarChartRodData(
                y: double.parse(score), colors: [Colors.white, Colors.white38])
          ],
          showingTooltipIndicators: [0],
        ),
      ];
  ...
  String calculateScore() {
    List<double> vals = [
      SpiritualModel.sliderValue1,
      SpiritualModel.sliderValue2,
      SpiritualModel.sliderValue3,
      SpiritualModel.sliderValue4,
      SpiritualModel.sliderValue5,
      SpiritualModel.sliderValue6
    ];
  ...
  Future<String> processScore() async {
    return api.processScore('spiritual', double.parse(score)).then((val) {
      if (val.isNotEmpty) {
  ...
  resetSliderValues() {
    SpiritualModel.sliderValue1 = 50;
    SpiritualModel.sliderValue2 = 50;
    SpiritualModel.sliderValue3 = 50;
    SpiritualModel.sliderValue4 = 50;
    SpiritualModel.sliderValue5 = 50;
    SpiritualModel.sliderValue6 = 50;
  }
}
