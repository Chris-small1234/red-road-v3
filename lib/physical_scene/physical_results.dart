...
class Physical_Results extends StatefulWidget {
  const Physical_Results({Key? key}) : super(key: key);

  @override
  _Physical_ResultsState createState() => _Physical_ResultsState();
}

class _Physical_ResultsState extends State<Physical_Results> {
  String score = "0";
  Api api = new Api();
  var thisScore;
  ...
  String calculateScore() {
    List<double> vals = [
      PhysicalSceneModel.sliderValue1,
      PhysicalSceneModel.sliderValue2,
      PhysicalSceneModel.sliderValue3,
      PhysicalSceneModel.sliderValue4,
      PhysicalSceneModel.sliderValue5,
      PhysicalSceneModel.sliderValue6
    ];
  ...
  Future<String> processScore() async {
    return api.processScore('physical', double.parse(score)).then((val) {
      if (val.isNotEmpty) {
  ...
  resetSliderValues() {
    PhysicalSceneModel.sliderValue1 = 50;
    PhysicalSceneModel.sliderValue2 = 50;
    PhysicalSceneModel.sliderValue3 = 50;
    PhysicalSceneModel.sliderValue4 = 50;
    PhysicalSceneModel.sliderValue5 = 50;
    PhysicalSceneModel.sliderValue6 = 50;
  }
}
