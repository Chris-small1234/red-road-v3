...
import 'package:red_road_v2/physical_scene/physical_scene.dart';
import 'package:red_road_v2/util/firebase_manager.dart';

class PhysicalWidget extends StatefulWidget {
  const PhysicalWidget({Key? key}) : super(key: key);
            ...
            new ElevatedButton(
              ...
              onPressed: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Physical()));
              },
            ),
          ],
        );
        ...
        return ElevatedButton(
          ...
          onPressed: () {
            ...
            if (today != snapshot.data) {
              ...
              Navigator.push(
                  context, MaterialPageRoute(builder: (context) => Physical()));
            } else {
              _dialog();
            }
          },
          child: Column(
            children: <Widget>[
              ...
              Container(
                ...
                height: 50,
                child: Image.asset(
                  './assets/homepage_icons/physical_logo.png',
                  fit: BoxFit.cover,
                ),
              ),
            ],
